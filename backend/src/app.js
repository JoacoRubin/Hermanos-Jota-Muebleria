  ...
  app.get('/', (req, res) => {
    res.json({
      ...
      endpoints: {
        ...
        agregarStock: 'POST /api/productos/:id/stock',
        movimientosStock: 'GET /api/productos/:id/movimientos',
        registro: 'POST /api/auth/register',
        login: 'POST /api/auth/login',
        refresh: 'POST /api/auth/refresh',
        logout: 'POST /api/auth/logout',
        olvideContrasena: 'POST /api/auth/forgot-password',
        restablecerContrasena: 'POST /api/auth/reset-password',
        perfil: 'GET /api/auth/profile',
        crearPedido: 'POST /api/orders',
        misPedidos: 'GET /api/orders/mis-pedidos',
        cancelarPedido: 'POST /api/orders/:id/cancelar',
        estadoPedido: 'PUT /api/orders/:id/estado',
